class Graph{
    ...
    removeEdge(vertex1, vertex2) {
        this.adjacencyList = this.adjacencyList[vertex1].filter( neighbor => neighbor != vertex2)
        this.adjacencyList = this.adjacencyList[vertex2].filter( neighbor => neighbor != vertex1)
    }
